...
module.exports = (scenario) => {
  scenario('App Flow Test', async(s, t, {liza}) => {
    ...
    */
    const kv_updates = await liza.app.call("host","get_kv_updates_dna_to_host",{});
    ...
    const kv_updates_2 = await liza.app.call("host","get_kv_updates_dna_to_host",{});
    ...
    await liza.app.call("host","kv_updates_host_completed",{kv_bundle:kv_updates_2.Ok.recently_enabled_apps});

    
    /// Calling this fn again should return no new kvs
    const kv_updates_3 = await liza.app.call("host","get_kv_updates_dna_to_host",{});
    ...
    await liza.app.call("host","kv_updates_host_completed",{kv_bundle:kv_updates_2.Ok.recently_disabled_apps});


    
    /// Calling this fn again should return no new kvs
    const kv_updates_4 = await liza.app.call("host","get_kv_updates_dna_to_host",{});
